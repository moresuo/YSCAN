        ...
        for host in hosts:
            with open(file=password, mode="r", encoding="utf-8") as passwords:
                for passwd in passwords:
                    executor.submit(scan_redis, host=host, port=port, password=passwd.strip(), ssh_pub_key=ssh_pub_key, ip=ip, listen_port=listen_port)
